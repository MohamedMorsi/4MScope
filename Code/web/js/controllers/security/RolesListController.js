angular.module('enozomApp').controller('RolesListController', ['$rootScope', '$scope', 'CRUDFactory', 'settings', '$location', '$translate', 'NgTableParams','GridService', function ($rootScope, $scope, CRUDFactory, settings, $location, $translate, NgTableParams,GridService) {
    //------------------------------Roles LIST PAGE---------------------------//
    $scope.filterObject = {};
